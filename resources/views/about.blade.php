        ...
        <div class="col-md-8 m-3">
            <div class="aboutUS">
                ...
                <p>Buuks adalah sebuah situs web yang memungkinkan pengguna untuk memberikan ulasan dan pendapat tentang buku-buku yang mereka baca. Dalam Buuks ini, terdapat fitur CRUD (Create, Read, Update, dan Delete) yang memungkinkan pengguna untuk melakukan operasi-operasi dasar terhadap data.</p>
                    <ul>
                        <li>Create: Pengguna dapat menambahkan ulasan baru tentang buku yang mereka baca, mencantumkan judul buku, nama penulis, dan ulasan singkat.</li>
                        ...
                        <li>Update: Pengguna dapat memperbarui ulasan buku yang sudah diterbitkan sebelumnya, mengubah ulasan atau menambahkan komentar baru.</li>
